...
public class EnemyBehavior : MonoBehaviour {
    ...
    {
        if (collision.collider.tag == "Platform") // if this object collides with the platform (floor)...
        {
            isGrounded = true;
        }
    }
    ...
    {
        if (collision.collider.tag == "Platform") // if this object disengages (collisionexits) from the platform (floor)...
        {
            isGrounded = false;
        }
    }
